...
Func TabItem3()
   ...
   $g_hChkGlobalChat = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkGlobalChat_01", "Advertise in global"), 32 - $x, 184 - $y, 155, 17)
   ...
   $g_hChkGlobalScramble = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkGlobalScramble_01", "Scramble global chats"), 32 - $x, 205 - $y, 170, 17)
   ...
   $g_hChkSwitchLang = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkSwitchLang_01", "Switch languages"), 210 - $x, 184 - $y, 115, 17)
   ...
   GUICtrlSetOnEvent(-1, "chkSwitchLang")   
	;======kychera===========
   $cmbLang = GUICtrlCreateCombo("", 330 - $x, 184 - $y, 50, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
   GUICtrlSetData(-1, "EN|FR|DE|ES|IT|NL|NO|PR|TR|RU", "RU")
   ;==========================
   
   $g_hChkRusLang = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkRusLang_01", "Russian"), $x + 190, $y - 55, 115, 17)
   ...
   $g_hChkClanChat = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkClanChat_01", "Chat in clan chat"), 32 - $x, 390 - $y, 97, 17)
   ...
   $g_hChkUseResponses = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkUseResponses_01", "Use custom responses"), 32 - $x, 410 - $y, 135, 17)
   ...
   $g_hChkUseGeneric = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design MOD - Chat", "chkUseGeneric_01", "Use generic chats"), 32 - $x, 430 - $y, 97, 17)
   ...
   _GUICtrlCreateIcon ($g_sLibIconPath, $eIcnTelegram, $x + 3, $y + 223, 32, 32)
