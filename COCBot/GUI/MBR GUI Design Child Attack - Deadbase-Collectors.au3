...
Func CreateAttackSearchDeadBaseCollectors()
	...
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "Group_01", "Collectors"), $x - 5, $y - 20, $g_iSizeWGrpTab4, $g_iSizeHGrpTab4)
		...
		$g_hChkDBDisableCollectorsFilter = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "ChkDisableCollectorsFilter", "Disable Collector Filter"), $x + 240, $y + 40, 150, 18); Was $x + 250, $y + 60 EDITED By Simple Mod
	...
	$y += 40
		...
		$g_ahCmbDBCollectorLevel[6] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
		...
		GUICtrlCreateLabel($g_hTxtFull, $x + 195, $y + 3); Was $x + 205 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel7", "Lvl 7. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[7] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel8", "Lvl 8. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[8] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel9", "Lvl 9. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[9] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel10", "Lvl 10. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[10] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel11", "Lvl 11. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[11] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		...
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblCollectorLevel12", "Lvl 12. Must be >"), $x + 40, $y + 3, -1, -1)
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_ahCmbDBCollectorLevel[12] = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
	...
	$y += 25
		GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "LblMinCollectorMatches", "Collectors required"), $x, $y + 3, -1, -1)
			...
			_GUICtrlSetTip(-1, $sTxtTip)
		$g_hCmbMinCollectorMatches = GUICtrlCreateCombo("", $x + 130, $y, 60, 20, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL)); Was $x + 125, $y, 75 EDITED By Simple Mod
			_GUICtrlSetTip(-1, $sTxtTip)
	...
	$y += 28
		...
		$g_hTxtDBMinCollOutsidePercent = _GUICtrlCreateInput("80", $x + 50, $y - 3, 31, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
