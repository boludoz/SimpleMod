...
Func _AutoUpgrade()
	...
	While 1
		...
		Switch $g_aUpgradeResourceCostDuration[0]
			Case "Gold"
				If ($g_aiCurrentLoot[$eLootGold] >= ($g_aUpgradeResourceCostDuration[1] + $g_iTxtSmartMinGold)) Or (($g_aiCurrentLoot[$eLootGold] >= g_aUpgradeResourceCostDuration[1]) And ($g_aUpgradeResourceCostDuration[1] > 11000000)) Then $bSufficentResourceToUpgrade = True
			Case "Elixir"
				If ($g_aiCurrentLoot[$eLootElixir] >= ($g_aUpgradeResourceCostDuration[1] + $g_iTxtSmartMinElixir)) Or (($g_aiCurrentLoot[$eLootElixir] >= $g_aUpgradeResourceCostDuration[1]) And ($g_aUpgradeResourceCostDuration[1] > 11000000)) Then $bSufficentResourceToUpgrade = True
			Case "Dark Elixir"
				If (($g_aiCurrentLoot[$eLootDarkElixir] >= ($g_aUpgradeResourceCostDuration[1] + $g_iTxtSmartMinDarkElixir))) Or (($g_aiCurrentLoot[$eLootDarkElixir] >= $g_aUpgradeResourceCostDuration[1]) And ($g_aUpgradeResourceCostDuration[1] > 200000)) Then $bSufficentResourceToUpgrade = True
		EndSwitch
