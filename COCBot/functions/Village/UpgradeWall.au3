...
Func UpgradeWall()
	...
	If $g_bAutoUpgradeWallsEnable = True Then
		...
		If $g_iFreeBuilderCount > 0 Then
			...
			Local $iElixierPriority = ($g_bAutoLabUpgradeEnable = False Or (($g_iCmbLaboratory > 18 Or $g_iCmbLaboratory = 0) Or $g_sLabUpgradeTime <> "")) And ($g_iChkAutoUpgrade = 0 Or ($g_iChkAutoUpgrade = 1 And $g_iChkResourcesToIgnore[1] = 1 And ($g_bUpgradeWallSaveBuilder = False Or ($g_iFreeBuilderCount = 1 And $g_bUpgradeWallSaveBuilder = True))))
